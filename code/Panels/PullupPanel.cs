...
{
    public class PullupPanel : ParentPanel
    {
        public NTC NTC
        {
            set
        ...
        public PullupPanel(Temperature.Units unit) : base(unit)
        {
            DesignCircuitGroup();
        }
        ...
        public override void DesignCircuitGroup()
        {
            ...
            this.TableDesignCircuit.Controls.Add(this.ImageResistor, 0, 3);
            this.TableDesignCircuit.Controls.Add(this.pictureBox2, 0, 2);
            this.TableDesignCircuit.Controls.Add(this.ImageNTC, 0, 1);
